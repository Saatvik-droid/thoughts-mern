            ...
            <Paper className={classes.paper}>
                ...
                <form className={classes.formContainer} onSubmit={handleSubmit}>
                    <Grid container justify="center" alignItems="center" spacing={2}>
                        ...
                        <CustomTextField name="password" label="Password" handleChange={handleChnage} type={showPassword ? 'text' : 'password'} handleShowPassword={() => {setShowPassword(!showPassword)}} half={!isLogIn}/>
                        {
                            !isLogIn && <CustomTextField name="confirmPassword" label="Confirm Password" handleChange={handleChnage} error={passwordError} half/>
                        }
